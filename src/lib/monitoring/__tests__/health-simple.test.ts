 ...
 * 
 * This test focuses on the core health check functionality
...
describe('HealthCheckSystem - Core Functionality', () => {
  beforeEach(() => {
  ...
  describe('Health Check Execution', () => {
    ...
    it('should determine overall status correctly', async () => {
      ...
      // Note: The system has default checks that might be unhealthy in test env
