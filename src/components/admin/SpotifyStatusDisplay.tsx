    ...
    <div className={`bg-elevated rounded-lg p-4 ${className}`}>
      ...
      {showHeader && (
        <div className="flex items-center justify-between mb-3">
          <div>
            <h2 className="text-xl font-semibold text-bone mb-1">Spotify Status</h2>
            <p className="text-muted text-sm">Real-time connection and playback status</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {status.connected && status.device && (
              <div className="flex items-center gap-2 px-3 py-1.5 bg-surface rounded-lg">
                ...
                <span className="text-xs text-muted">{status.device.name}</span>
      ...
      {(error || status.error || status.requires_manual_reconnect || status.status_message) && (
        <div className="mb-4 space-y-2">
          ...
          {status.status_message && !error && !status.error && (
            <div className="flex items-center space-x-2 text-muted bg-surface/60 border border-white/10 rounded-lg p-3">
              <AlertCircle className="w-4 h-4 flex-shrink-0" />
      ...
      {status.connected && status.currentTrack && (
        <div>
          <h3 className="text-lg font-semibold text-bone mb-3">Now Playing</h3>
          ...
          <div className="bg-surface rounded-lg p-3">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-medium text-bone truncate">
              ...
              <button
                ...
                className="flex-shrink-0 w-12 h-12 bg-surface hover:bg-elevated disabled:bg-surface text-bone rounded-full flex items-center justify-center transition-colors"
            ...
            <div className="mt-4">
              <div className="w-full bg-surface rounded-full h-2">
                <div 
                  className="h-2 rounded-full bg-gradient-to-r from-accent to-accent-hover transition-all duration-200"
      ...
      {status.connected && !status.currentTrack && (
        <div className="space-y-4">
          <div className="text-center py-6">
            ...
            <h3 className="text-lg font-semibold text-muted mb-2">No Track Playing</h3>
              ...
              <div className="mb-4 max-w-md mx-auto">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3 bg-surface border border-white/10 rounded-lg text-bone appearance-none cursor-pointer hover:bg-surface transition-colors pr-10"
                  >
                    {devices.map((device) => (
                ...
                <p className="text-xs text-faint mt-2 text-left">
      ...
      {!status.connected && (
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-semibold text-muted mb-2">Spotify Not Connected</h3>
